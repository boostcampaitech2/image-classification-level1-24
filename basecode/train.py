...
def train(data_dir, model_dir, args):
    ...
    model = model_module(model_name=args.sub_model, num_classes = num_classes).get_model().to(device)
...
def train2(data_dir, model_dir, args):
    seed_everything(args.seed)




def train3(data_dir, model_dir, args):
    seed_everything(args.seed)




def train4(data_dir, model_dir, args):
    seed_everything(args.seed)




def train5(data_dir, model_dir, args):
    seed_everything(args.seed)




def train6(data_dir, model_dir, args):
    seed_everything(args.seed)   




def train7(data_dir, model_dir, args):
    seed_everything(args.seed)   
...
if __name__ == '__main__':
    ...
    parser.add_argument('--sub_model', type=str, default='efficientnet-b0', help='model type (default: efficientnet-b0)')
